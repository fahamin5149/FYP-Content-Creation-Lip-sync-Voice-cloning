...
const pricingPlans = [
  {
    name: "Basic",
    price: "Free",
    description: "Perfect for testing our AI video generation",
    features: ["5 videos per month", "Basic voice cloning", "Standard avatars", "Community support"],
    popular: false,
    cta: "Get Started",
  },
  {
  ...
  },
  {
    ...
    monthlyPrice: 199,
    annualPrice: 159,
    description: "For businesses and large-scale production",
    features: [
      "Everything in Pro",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">
            Start creating professional AI-generated videos today. Scale your content production with our advanced voice
            cloning and avatar technology.
          </p>
        ...
        >
          <p className="text-white/60 mb-4">Need a custom AI solution? We're here to help.</p>
          <motion.button
