        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-white sm:text-6xl lg:text-7xl">
                AI-Powered Multi-Modal <br />
                Content Generation with <br />
          ...
          >
            <div className="text-center">
              <p className="text-sm text-white/80 mb-6">Powered by cutting-edge AI technology</p>
