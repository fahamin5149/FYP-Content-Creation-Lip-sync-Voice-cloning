      ...
      <div className="container mx-auto px-4 2xl:max-w-[1400px]">
        ...
        <div className="mx-auto mt-5 max-w-3xl text-center">
          ...
          >
            ...
            />
            Urdu Video Generation. Create. Clone. Captivate.
          </motion.h1>
        </div>
        <motion.div
        ...
        >
          <p className="text-muted-foreground text-xl">
            Transform text into professional Urdu videos with your cloned voice and personalized avatar. One setup,
