  ...
  return (
    <div className="min-h-screen bg-black flex flex-col lg:flex-row">
      ...
      <motion.div
        ...
        className="relative lg:w-1/2 w-full min-h-[40vh] lg:min-h-screen bg-gradient-to-br from-zinc-900 via-black to-zinc-900 flex flex-col justify-between p-8 lg:p-12 overflow-hidden"
      >
        {/* Background Effects */}
        <div className="absolute top-20 left-20 w-96 h-96 bg-[#e78a53]/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-20 right-20 w-72 h-72 bg-[#e78a53]/10 rounded-full blur-3xl" />
        ...
        <div className="relative z-10">
          <Link
            href="/"
            className="inline-flex items-center space-x-2 text-zinc-400 hover:text-[#e78a53] transition-colors duration-200 mb-8"
          >
          ...
          >
            ...
            <p className="text-lg text-zinc-400 max-w-md">
              AI-powered voice cloning and lip-sync technology for professional content creation.
            </p>
          </motion.div>
        </div>
        ...
        >
          <div className="relative">
            <div className="w-64 h-64 border-2 border-[#e78a53]/30 rounded-3xl rotate-12 absolute top-0 left-0" />
            <div className="w-64 h-64 bg-gradient-to-br from-[#e78a53]/20 to-transparent rounded-3xl -rotate-6" />
          </div>
        </motion.div>

        {/* Bottom Section - Testimonial/Feature Card */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800/50 rounded-2xl p-6 max-w-md">
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#e78a53] to-[#d67843] flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">
                  Sign in to access your AI-powered video projects, voice models, and lip-sync content instantly.
                </p>
              </div>
            </div>
          </div>
      ...
      <motion.div
        ...
        className="lg:w-1/2 w-full min-h-screen bg-black flex items-center justify-center p-4 lg:p-12"
      >
        <div className="w-full max-w-md">
          ...
          >
            ...
            <p className="text-zinc-400">Sign in to your account to continue creating</p>
          </motion.div> */}
            ...
            <SignIn
              appearance={{
                ...
                elements: {
                  ...
                  footer: "hidden",
                  forgotPasswordLink: "text-[#e78a53] hover:text-[#e78a53]/80 text-sm",
                  ...
                  identityPreviewBox: "bg-transparent",                  formHeaderTitle: "text-white",
